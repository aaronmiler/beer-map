...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { abv: @beer.abv, brewery_id: @beer.brewery_id, desc: @beer.desc, ibu: @beer.ibu, name: @beer.name }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { abv: @beer.abv, brewery_id: @beer.brewery_id, desc: @beer.desc, ibu: @beer.ibu, name: @beer.name }
    assert_redirected_to beer_path(assigns(:beer))
  end
